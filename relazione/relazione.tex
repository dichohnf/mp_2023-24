...
\begin{document}	
	...
	\lstinputlisting[firstline=46, lastline=63, caption={Test del metodo \textit{equals(other)} per la classe \texttt{jds.display.interfaces.VideoInterface}.}, label=lst:test-videointerface-equals]{../tests/jds/display/interfaces/VideoInterfaceTest.java}
	...
	\lstinputlisting[firstline=67, lastline=75, caption={Test del metodo \textit{getData()} per la classe \texttt{jds.display.videostream.ComposedFrame}.}, label=lst:test-composedframe-getdata]{../tests/jds/videostream/ComposedFrameTest.java}
	...
	\lstinputlisting[firstline=53, lastline=65, caption={Test del metodo \textit{nextFrame()} per la classe \texttt{jds.display.videostream.VideoStream}.}, label=lst:test-videostream-nextframe]{../tests/jds/videostream/VideoStreamTest.java}
