...
\begin{document}	
	...
	\lstinputlisting[firstline=43, lastline=59, caption={Test per la classe \texttt{jds.display.malfunction.UnexpectedlyChangedResolutionCheckerTest}.}, label=lst:test-changed-resolution]{../tests/jds/display/malfunction/UnexpectedlyChangedResolutionCheckerTest.java}
