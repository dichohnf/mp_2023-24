...
\begin{document}	
	...
	\lstinputlisting[firstline=53, lastline=64, caption={Test del metodo \textit{nextFrame()} per la classe \texttt{jds.display.videostream.VideoStream}.}, label=lst:test-videostream-nextframe]{/home/madict/eclipse-workspace-prove_mp/jds/videostream/VideoStreamTest.java}
